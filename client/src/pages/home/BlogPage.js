...
const BlogPage = () => {
  ...
  const [blogs, setBlogs] = useState([
    { id: 1, title: "Understanding Real Estate Market Trends", category: "Market", image: "/images/market-trends.jpg", likes: 561, comments: 24, shares: 5, author: "John Doe", publishedDate: "October 25, 2024" },
    { id: 2, title: "How to Choose the Best Neighborhood", category: "Tips", image: "/images/choose-neighborhood.jpg", likes: 234, comments: 13, shares: 7, author: "Jane Smith", publishedDate: "October 22, 2024" },
    { id: 3, title: "Real Estate Investment Strategies", category: "Investment", image: "/images/investment.jpg", likes: 672, comments: 18, shares: 9, author: "Alex Johnson", publishedDate: "October 15, 2024" },
  ...
  return (
    <div className="blog-page">
      ...
      <div className="main-content">
        <TabsFilter currentCategory={currentCategory} setCategory={setCategory} />
